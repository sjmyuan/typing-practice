...
describe('ProgressDisplay', () => {
  ...
  describe('Progress Display', () => {
    it('displays progress when characters have been typed', () => {
      ...
      expect(screen.getByText('Progress: 5/10 characters')).toBeInTheDocument();
    });
    ...
    it('displays both progress and accuracy in same line', () => {
      render(<ProgressDisplay typedCount={5} totalCount={10} correctCount={4} />);
      const progressText = screen.getByText(/Progress: 5\/10 characters/);
    ...
    it('displays correct progress with different values', () => {
      ...
      expect(screen.getByText('Progress: 3/8 characters')).toBeInTheDocument();
    });
  });
  ...
  describe('Edge Cases', () => {
    ...
    it('handles correctCount greater than typedCount', () => {
      ...
      expect(screen.getByText('Progress: 3/10 characters')).toBeInTheDocument();
    ...
    it('handles typedCount greater than totalCount', () => {
      ...
      expect(screen.getByText('Progress: 15/10 characters')).toBeInTheDocument();
      expect(screen.getByText('Accuracy: 67%')).toBeInTheDocument();
    });
    ...
    it('handles float values by treating them as integers', () => {
      ...
      expect(screen.getByText('Progress: 3.7/10.2 characters')).toBeInTheDocument();
    });
  });
  ...
  describe('Styling', () => {
    it('applies correct CSS classes', () => {
      render(<ProgressDisplay typedCount={5} totalCount={10} correctCount={4} />);
      const container = screen.getByText(/Progress:/).parentElement;
